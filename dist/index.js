...
async function run() {
  ...
  if (jobSummary) {
    await summary.addHeading("HTML Preview Action").addRaw(`Using HTML file: ${htmlFile}`).addBreak().addBreak().addLink("Click here to preview the HTML page in your browser", previewUrl).write();
  }
}
run().catch((error2) => {
